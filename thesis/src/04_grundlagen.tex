...
\chapter{Grundlagen}\label{chapter: Grundlagen}	
	...
	Nach \cite{european_commission_joint_research_centre_blockchain_2017} kann angenommen werden, dass ...
	
	Energie besteht aus Exergie und Anergie \cite[S. 15]{weingartner_identity_2021}.
