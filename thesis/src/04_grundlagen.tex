...
As mentioned in chapter \ref{chapter: Introduction}, current implementations of such digital identities are insufficient for the problems of our modern times. \cite{soltani_survey_2021} divided these problems into four categories:
\begin{enumerate}
		...
		\begin{lstlisting}[language=json, caption={[Plaintext DIDComm message]Plaintext DIDComm message (extracted from \cite{hardman_didcomm_2021})}, captionpos=b, label={listing: didcomm example}]  
{
    ...
    "body": {
      "messagespecificattribute": "and its value"
	    ...
	    \begin{figure}[htp]
    	    \centering
    	    \makebox[\textwidth]{\includesvg[inkscapelatex=false, width=0.8\textwidth]{img/12_revocationlist.svg}}
