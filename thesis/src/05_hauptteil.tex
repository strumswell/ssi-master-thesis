 ...
 toWallet: boolean): Promise<Buffer> {
    ...
    \begin{table}[ht!]
    	\begin{threeparttable}
            ...
            \textbf{Revoke VC}      & \textbf{Implemented}  & \ding{51}   & \ding{51}     & \ding{51}\tnote{3, 4}  & \ding{55}\tnote{5} \\
            \textbf{Delete VC}      & \textbf{Implemented~} & \ding{51}   & \ding{51}     & \ding{51}    & \ding{55}\tnote{5}    \\
            \textbf{Derive VC}      & \textbf{Implemented~} & \ding{55}    & \ding{55}      & \ding{55}     & \ding{55}     \\
                                    & Indirect              & \ding{51}             & \ding{51}               & \ding{55}               & \ding{55}               \\
            \hline
            \textbf{Score} &  & 75\% & 65\% & 75\% & 50\%\\
            \bottomrule
            \end{tabular*}
            \begin{tablenotes}\footnotesize 
        		...
        		\item[5] Part of another, unreachable system
    		\end{tablenotes}
