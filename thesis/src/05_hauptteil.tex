...
export class VeramoProvider implements ServiceProvider {
  ...
  ...
    ...
    \begin{figure}[ht]
	    \centering    	    \makebox[\textwidth]{\includesvg[inkscapelatex=false, width=\textwidth]{img/7_architecture_detail.svg}}       \caption{System architecture (TODO: fix)}
 ...
 toWallet: boolean): Promise<Buffer> {
    ...
    \begin{table}[htp]
        ...
        \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} lllll}
            ...
            \vcell{\textbf{Messaging}} & \vcell{DIDComm v2}                                                  & \vcell{DIDComm v1}                                                 & \vcell{DIDComm v2}                                               & \vcell{\ding{55}}         \\[-\rowheight]
